/**
 * laporan.js
 * Modul Frontend Laporan & Rekonsiliasi - Safe State Pattern
 */

// Gunakan window assignment agar terhindar dari error 'already been declared'
window.LaporanModule = window.LaporanModule || {
  filterData: {
          ...
          <div class="row g-4">
            ...
            <div class="col-12 col-sm-6 col-xl-3">
              <div class="panel p-3 bg-white text-dark">
                <small class="text-uppercase text-muted fw-bold d-block mb-1">Total Kunjungan</small>
                <h3 id="stat-total-kunjungan" class="fw-bold mb-0">0 Pasien</h3>
              </div>
            </div>
            <div class="col-12 col-sm-6 col-xl-3">
              <div class="panel p-3 bg-white text-dark">
                <small class="text-uppercase text-muted fw-bold d-block mb-1">Omset Tunai</small>
                <h3 id="stat-omset-tunai" class="fw-bold text-success mb-0">Rp 0</h3>
              </div>
            </div>
            <div class="col-12 col-sm-6 col-xl-3">
              <div class="panel p-3 bg-white text-dark">
                <small class="text-uppercase text-muted fw-bold d-block mb-1">Omset Non-Tunai</small>
                <h3 id="stat-omset-nontunai" class="fw-bold text-primary mb-0">Rp 0</h3>
              </div>
            </div>
            <div class="col-12 col-sm-6 col-xl-3">
              <div class="panel p-3 bg-white text-dark">
                <small class="text-uppercase text-muted fw-bold d-block mb-1">Kunjungan BPJS</small>
  ...
  tarikDataLaporan: async function() {
    ...
    try {
      ...
      console.log("Mockup data active or connection deferred.");
    }
  }
};
